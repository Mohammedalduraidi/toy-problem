...
function mergeSort(arr) {
    ...
    //[2,34,35,24,35,6,17,28,99]
    var half = Math.floor(arr.length / 2)
    var arr1 = arr.slice(0, half)
    var arr2 = arr.slice(half, arr.length)
    var callBack = concatenation(mergeSort(arr1), mergeSort(arr2))
    return callBack;
}
...
function concatenation(firstArray, secondArray) {
    ...
    var merge = result.concat(firstArray) || result.concat(secondArray)
