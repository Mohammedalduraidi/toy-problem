...
BinaryHeap.prototype.insert = function (value) {
    ...
    //define a temp var to use it in swap.
    var check;
    // start swapping proccess.
    for (var i = 0; i < this._heap.length; i++) {
        for (var j = 0; j < this._heap.length; j++ && i !== j) {
    ...
    console.log("hello world", this._heap)
}
// remove function
BinaryHeap.prototype.removeRoot = function () {
    ...
    if (this._heap.length === 0) {
        ...
        // if it is not empty return the first element.
        var pop = this._heap.splice(0, 1)
